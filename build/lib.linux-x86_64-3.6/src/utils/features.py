...
from src.utils.geometric import add_ones, s1_diff_deg, s1_dist_deg, l2_distances

from src.utils.orbslam2_features import _backend 
...
def sat_num_features(kps, des=None, num_features=2000):    
...
def kdt_nms(kps, des=None, num_features=2000, r=1, k_max=9):
...
def ssc_nms(kps, des, cols, rows, num_ret_points=2000, tolerance=0.1):
...
def octree_nms(frame, kps, num_features):
    ...
    kps_tuples = _backend.ORBextractor.DistributeOctTree(kps_tuples,minX,maxX,minY,maxY,num_features,0)
